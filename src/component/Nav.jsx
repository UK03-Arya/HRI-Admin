...
<p className='text-xs ml-2 mt-1  sm:space-x-2 xl:ml-4 xl:block lg:block md:block hidden '> Help & FAQ</p>
<img src={Profile} alt="img" className="w-4 h-4 mt-1 ml-4 sm:w-6 sm:h-6 sm:mt-0 " />
