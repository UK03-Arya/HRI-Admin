...
const Nav = () => {
  return (
    ...
    <div className='flex flex-wrap mt-4  absolute h-10 p-8  xl:w-[1359px] xl:h-[60px]  md:w-[700px]  lg:w-[980px] lg:h-[60px] w-[375px]  xl:mx-40  lg:mx-12 md:mx-10  drop-shadow-xl rounded-2xl bg-white justify-between space-x-4    xl:space-x-80 lg:justify-between md:justify-between 	'>
