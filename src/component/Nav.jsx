...
const Nav = () => {
  return (
   <div className=''>
    <div className='flex absolute flex-wrap mt-10 h-12  mx-10 xl:mx-40 lg:mx-10 md:mx-10 p-4 drop-shadow-xl rounded-2xl bg-white   space-x-12  xl:space-x-80 lg:space-x-80 md:space-x-20 	'>
